...
const VARIANTS = {
    primary:
        "bg-emerald-500 text-white hover:bg-emerald-600 shadow-md shadow-emerald-500/25 hover:-translate-y-0.5",
...
export default function Button({
    ...
    const classes = `inline-flex items-center justify-center rounded-xl font-semibold transition-all duration-200 ${VARIANTS[variant]} ${SIZES[size]} ${className}`;
